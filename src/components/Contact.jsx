...
const socialLinks = [
    ...
    {
      href: 'https://www.linkedin.com/in/carlos-alberto-couste-montesdeoca-2b31bb204?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BRX%2Fa5fZ9Q3WHocC5EUoSjQ%3D%3D',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://www.instagram.com/cacoc35',
  ...
  return (
    <section id="contact" className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            <form action="https://getform.io/f/bxoowlja" method="POST" className="xl:pl-10 2xl:pl-20 ">
                <div className="md:grid md:items-center md:grid-cols-1 md:gap-2">
                    <div className="mb-4">
                        <label htmlFor="name" className="label reveal-up">Nombre:</label>
                        <input type="text" name="name" id="name" autoComplete="" required placeholder="Carlos Cousté" className="text-field reveal-up" />
                    </div>
                    <div className="mb-4">
                        <label htmlFor="email" className="label reveal-up">Email:</label>
                        <input type="email" name="email" id="email" autoComplete="" required placeholder="carlos@ejemplo.com" className="text-field reveal-up" />
                    </div>
                    <div className="mb-4">
